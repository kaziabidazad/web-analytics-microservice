...
//
//    private final TwitterKafkaStreamRunner twitterKafkaStatusListener;
//
...
//
//    public TwitterV2StreamHelper(TwitterKafkaStreamRunner twitterKafkaStatusListener) {
...
//                .setDefaultRequestConfig(RequestConfig.custom().setCookieSpec(StandardCookieSpec.RELAXED).build()).build();
//
//        URIBuilder uriBuilder = new URIBuilder(twitterBasUrl);
//
